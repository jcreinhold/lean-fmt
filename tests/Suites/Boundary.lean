...
private def testEntryPointSet (root : System.FilePath) : IO Unit := do
  ...
  let expected :=
    #["Main.lean", "tests/Suites/ApplicationFormatter.lean", "tests/Suites/BlockFormatter.lean",
      ...
      "tests/Test/Runner.lean", "tests/Test/Unit.lean", "tests/lsp/Acceptance.lean",
