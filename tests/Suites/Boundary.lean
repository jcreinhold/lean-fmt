...
private def testEntryPointSet (root : System.FilePath) : IO Unit := do
  ...
  let expected := #[
    ...
    "tests/Suites/FormatSuppression.lean", "tests/Suites/Imports.lean",
    "tests/Suites/Incremental.lean", "tests/Suites/Layout.lean", "tests/Suites/Lossless.lean",
    "tests/Suites/ModuleFormatter.lean", "tests/Suites/Reporting.lean", "tests/Suites/Style.lean",
    "tests/Suites/Suppression.lean", "tests/Suites/Syntax.lean", "tests/Suites/TermFormatter.lean",
    "tests/Suites/Validator.lean", "tests/Test/Runner.lean", "tests/Test/Unit.lean",
