...
private def testEntryPointSet (root : System.FilePath) : IO Unit := do
  ...
  let expected := #[
    ...
    "tests/Suites/Discovery.lean", "tests/Suites/Downstream.lean",
    "tests/Suites/FormatSuppression.lean",
    ...
    "tests/Suites/ModuleFormatter.lean", "tests/Suites/NativeLayout.lean", "tests/Suites/Performance.lean",
    "tests/Suites/Reporting.lean", "tests/Suites/Scale.lean", "tests/Suites/Semantic.lean",
    "tests/Suites/Stream.lean", "tests/Suites/Style.lean", "tests/Suites/Suppression.lean",
