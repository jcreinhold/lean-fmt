...
public unsafe def main (args : List String) : IO UInt32 := do
  ...
  | ["doc-bench"] =>
    Unit.Tools.docBench
  | ["doc-step-counts"] =>
    Unit.Tools.docStepCounts
  | ["doc-dump"] =>
    Unit.Tools.docDump
  | ["report-bench"] =>
    Unit.Tools.reportBench
  | ["security-bench"] =>
    Unit.Tools.securityBench
  | ["formatter-header", sourcePath] =>
    Unit.Tools.formatterHeader sourcePath
  ...
  | ["verify-official-facet", root, sourcePath] =>
    do
      ...
      return 0
  | _ =>
    runCases "lean-fmt-tests" allCases args
