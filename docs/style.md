...
mathlib source layout. One blank line separates top-level declaration-like commands; cohesive setup commands (`open`,
`export`, `universe`, `variable`, local options) may stay adjacent. Empty vertical padding is not preserved: a run of
