---
claim_id: RLP-PROTOCOL
status: planned
depends_on: []
---

# Freeze LSP capability and state model
...
- Write `results/01-protocol.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RLP-PROTOCOL verified.
