---
claim_id: RLP-FEATURES
status: verified
depends_on: [RLP-DOCUMENTS]
---

# Implement diagnostics, formatting, and code actions
...
- Write `results/03-features.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RLP-FEATURES verified.
