...
claim_id: RLP-FINAL
status: verified
depends_on: [RLP-FEATURES]
---

# Run protocol, editor, and resource acceptance
...
- Write `results/04-acceptance.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RLP-FINAL verified.
