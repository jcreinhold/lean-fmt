...
- **The whole stack is complete.** All three claims verified; 21 suites, build, lint, and unit tests pass. Next is `ruff-20-acceptance`, which also owns the `tests/watch` §9.6 staged-file defect.
