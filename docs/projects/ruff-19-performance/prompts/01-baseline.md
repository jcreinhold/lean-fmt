...
# Freeze feature-complete workloads and budgets
...
- Write `results/01-baseline.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RPR-SPEC verified.
