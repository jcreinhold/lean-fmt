...
# Remove repeated work and measure private concurrency
...
- Write `results/02-optimize.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RPR-IMPL verified.
