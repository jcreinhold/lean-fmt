...
| nodes whose subtree contains no token at all | **29,942 — 34.9%** |
| …of those, whose parent also has direct token children | **13,593 — 15.8% of all nodes** |
...
**Therefore arg order cannot be recovered from positions.** For 13,593 of 85,832 nodes, an empty
...
- **The conservative fallback reads tokens, not the tree.** This is the load-bearing consequence of
  ...
  with their trivia is unaffected by all 13,593 ambiguous placements. Unknown syntax round-trips
