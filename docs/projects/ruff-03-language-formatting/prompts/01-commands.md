---
claim_id: RLF-COMMANDS
status: verified
depends_on: []
---

# Format modules, headers, imports, namespaces, and declarations
...
- Write `results/01-commands.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RLF-COMMANDS verified.
