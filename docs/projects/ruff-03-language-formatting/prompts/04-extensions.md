---
claim_id: RLF-EXTENSIONS
status: planned
depends_on: [RLF-TACTICS]
---

# Handle macros and file-local syntax conservatively
...
- Write `results/04-extensions.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RLF-EXTENSIONS verified.
