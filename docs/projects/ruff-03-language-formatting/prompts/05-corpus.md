...
claim_id: RLF-FINAL
status: planned
depends_on: [RLF-EXTENSIONS]
---

# Close whole-language coverage and style policy
...
- Write `results/05-corpus.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RLF-FINAL verified.
