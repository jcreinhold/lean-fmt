---
claim_id: RLF-TACTICS
status: planned
depends_on: [RLF-EXPRESSIONS]
---

# Format tactic sequences, `do` notation, and layout-sensitive blocks
...
- Write `results/03-tactics.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RLF-TACTICS verified.
