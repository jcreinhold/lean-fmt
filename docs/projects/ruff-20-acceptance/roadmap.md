...
- Run whole-language formatting/idempotence, all rule tiers, fix safety, suppressions, config, streaming/ranges, report formats, watch, LSP, integrations, packaging, and deep-module audits.
