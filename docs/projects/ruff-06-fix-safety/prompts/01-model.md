...
# Freeze applicability and conflict semantics
...
- Write `results/01-model.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RFX-SPEC verified.
