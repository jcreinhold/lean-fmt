...
# Freeze formatting policy and CLI semantics
...
- Write `results/01-policy.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RFP-SPEC verified.
