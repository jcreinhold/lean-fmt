...
# Design the layout abstraction twice
...
- Write `results/01-design.md` with exact commands, raw outputs or evidence locators, measurements,
...
- Run `git diff --check` and read all output before marking RLC-SPEC verified.
